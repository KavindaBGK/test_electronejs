...
class ExtensionHost {
  ...
  async activateExtension(extensionId) {
    ...
    try {
      ...
      try {
        const moduleUrl = `file://${mainModulePath.replace(/\\/g, "/")}`;
        ...
        if (typeof module.activate === "function") {
          ...
          console.log(`Extension ${extensionId} activated successfully as ES module`);
        } else {
          console.warn(`Module doesn't export an activate function`);
